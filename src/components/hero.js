      ...
      <div className="support-features">
        ...
        <div className="support-icons">
          <div className="support-icon">
            ...
            <h3>Traffic</h3>
            <p>Boost social media traffic <br /> with advanced analytical tools</p>
          </div>
          <div className="support-icon">
            <img src={icon2} alt="Feature 2" />
            <h3>Branding</h3>
            <p>Effortlessly enhance branding <br />with customizable design <br />templates and tools</p>
          </div>
          <div className="support-icon">
            <img src={icon3} alt="Feature 3" />
            <h3>Website</h3>
            <p>Create your website easily with <br />intutive site building tools</p>
          </div>
        </div>
      </div>
    </section>
